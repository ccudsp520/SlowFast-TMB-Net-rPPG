...
from nets.models.sub_models.LinearModel_size72 import LinearModel_SlowFast, AFF_SlowFast
from nets.models.sub_models.MotionModel_size72 import MotionModel_TS_CSTM
from torchvision import transforms


class  SlowFast_FD(torch.nn.Module):
    def __init__(self, frame_depth, pop_mean, pop_std, eca, shift_factor, group_on,skip):
        super().__init__()
        ...
        self.motion_model_fast = MotionModel_TS_CSTM(eca, fast_channels, self.kernel_size, frame_depth, shift_factor, group_on,skip)   #shift_factor
        self.motion_model_slow = MotionModel_TS_CSTM(eca, slow_channels, self.kernel_size, frame_depth//2, shift_factor, group_on,skip)
